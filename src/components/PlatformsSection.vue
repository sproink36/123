      ...
      <div class="grid_block">
        <div class="website">
          ...
          <p class="text">
            ...
            Управляйте QR-кодами, статистикой<br />и проектами прямо с сайта.
        ...
        <div class="extension">
          ...
          <p class="text">
            Делайте всё быстрее и проще<br />
            прямо в браузере. Создавайте<br />
            и управляйте QR-кодам и без необходимости переходить<br />
            на сайт.
          </p>
          <div class="footer">
